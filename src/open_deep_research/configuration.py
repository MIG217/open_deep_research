...
class Configuration:
    ...
    supervisor_provider: str = "google_genai"
    supervisor_model: str = "gemini-2.0-flash" # Model for supervisor agent in multi-agent setup
    researcher_provider: str = "google_genai"
    researcher_model: str = "gemini-2.0-flash" # Model for research agents in multi-agent setup 
